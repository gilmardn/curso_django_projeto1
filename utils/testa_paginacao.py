...
class PaginationTest(TestCase):
    def testa_intervalo_de_paginacao_retorna_um_intervalo_de_paginacao(self):
    ...
    def testa_primeiro_intervalo_se_estatico_se_a_pagina_atual_for_menor_que_página_do_meio(self):
